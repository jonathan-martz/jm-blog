      ...
      <div class="col-span-6 md:col-span-2">
        ...
        <div class="grid grid-cols-2 gap-2 mt-2">
          <div class="col-span-2">
            <a
              href="https://github.com/jonathan-martz/"
              target="_blank"
              class="flex px-2 py-2 mt-2 text-black bg-white border-2 border-black md:mt-0"
            >
          ...
          <div class="col-span-2">
            <a
              href="https://de.linkedin.com/in/jonathan-martz-3066a6172"
              target="_blank"
              class="flex px-2 py-2 mt-2 text-black bg-white border-2 border-black md:mt-0"
            >
      ...
      <div class="col-span-6 md:col-span-4">
        <div class="grid grid-cols-6">
          ...
          <div
            ...
            :key="index"
            class="col-span-6 mt-2 xs:col-span-3"
          >
